...
public class BlockPlacedProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		...
		if ((blockstate.getBlock() == Blocks.CARVED_PUMPKIN || blockstate.getBlock() == Blocks.JACK_O_LANTERN)
				&& (world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()
				&& (world.getBlockState(new BlockPos(x, y - 2, z))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()) {
			if ((world.getBlockState(new BlockPos(x + 1, y - 1, z))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x - 1, y - 1, z))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x + 1, y - 1, z), false);
				world.destroyBlock(new BlockPos(x - 1, y - 1, z), false);
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = new LonsdaleiteGolemEntity(MmoservermodModEntities.LONSDALEITE_GOLEM.get(), _level);
					entityToSpawn.moveTo((x + 0.5), (y - 2), (z + 0.5), world.getRandom().nextFloat() * 360F, 0);
					if (entityToSpawn instanceof Mob _mobToSpawn)
						_mobToSpawn.finalizeSpawn(_level, world.getCurrentDifficultyAt(entityToSpawn.blockPosition()), MobSpawnType.MOB_SUMMONED,
								null, null);
			...
			} else if ((world.getBlockState(new BlockPos(x, y - 1, z + 1))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x, y - 1, z - 1))).getBlock() == MmoservermodModBlocks.LONSDALEITE_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z + 1), false);
		...
		if ((blockstate.getBlock() == Blocks.CARVED_PUMPKIN || blockstate.getBlock() == Blocks.JACK_O_LANTERN)
				&& (world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()
				&& (world.getBlockState(new BlockPos(x, y - 2, z))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()) {
			if ((world.getBlockState(new BlockPos(x + 1, y - 1, z))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x - 1, y - 1, z))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x + 1, y - 1, z), false);
				world.destroyBlock(new BlockPos(x - 1, y - 1, z), false);
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = new OrichalcumGolemEntity(MmoservermodModEntities.ORICHALCUM_GOLEM.get(), _level);
					entityToSpawn.moveTo((x + 0.5), (y - 2), (z + 0.5), world.getRandom().nextFloat() * 360F, 0);
					if (entityToSpawn instanceof Mob _mobToSpawn)
						_mobToSpawn.finalizeSpawn(_level, world.getCurrentDifficultyAt(entityToSpawn.blockPosition()), MobSpawnType.MOB_SUMMONED,
								null, null);
			...
			} else if ((world.getBlockState(new BlockPos(x, y - 1, z + 1))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x, y - 1, z - 1))).getBlock() == MmoservermodModBlocks.ORICHALCUM_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z + 1), false);
		...
		if ((blockstate.getBlock() == Blocks.CARVED_PUMPKIN || blockstate.getBlock() == Blocks.JACK_O_LANTERN)
				&& (world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()
				&& (world.getBlockState(new BlockPos(x, y - 2, z))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()) {
			if ((world.getBlockState(new BlockPos(x + 1, y - 1, z))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x - 1, y - 1, z))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x + 1, y - 1, z), false);
				world.destroyBlock(new BlockPos(x - 1, y - 1, z), false);
				if (world instanceof ServerLevel _level) {
					Entity entityToSpawn = new AdamantineGolemEntity(MmoservermodModEntities.ADAMANTINE_GOLEM.get(), _level);
					entityToSpawn.moveTo((x + 0.5), (y - 2), (z + 0.5), world.getRandom().nextFloat() * 360F, 0);
					if (entityToSpawn instanceof Mob _mobToSpawn)
						_mobToSpawn.finalizeSpawn(_level, world.getCurrentDifficultyAt(entityToSpawn.blockPosition()), MobSpawnType.MOB_SUMMONED,
								null, null);
			...
			} else if ((world.getBlockState(new BlockPos(x, y - 1, z + 1))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()
					&& (world.getBlockState(new BlockPos(x, y - 1, z - 1))).getBlock() == MmoservermodModBlocks.ADAMANTINE_BLOCK.get()) {
				world.destroyBlock(new BlockPos(x, y, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z), false);
				world.destroyBlock(new BlockPos(x, y - 2, z), false);
				world.destroyBlock(new BlockPos(x, y - 1, z + 1), false);
