		...
		if (entity instanceof Player) {
			{
				...
				if (!_ent.level.isClientSide() && _ent.getServer() != null)
					_ent.getServer().getCommands()
							.performCommand(_ent.createCommandSourceStack().withSuppressedOutput().withPermission(4),
									("/attribute @s minecraft:generic.max_health base set " + ((entity
											...
											+ ((entity.getCapability(MmoservermodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													...
													* (entity.getCapability(MmoservermodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
															.orElse(new MmoservermodModVariables.PlayerVariables())).player_system_multiplier)));
			}
			{
