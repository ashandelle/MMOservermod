...
import net.mcreator.mmoservermod.procedures.NetheriteGolemRightClickedOnEntityProcedure;
import net.mcreator.mmoservermod.init.MmoservermodModEntities;

public class NetheriteGolemEntity extends PathfinderMob {
	public NetheriteGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MmoservermodModEntities.NETHERITE_GOLEM.get(), world);
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		NetheriteGolemRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
