...
public class NetheriteGolemEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(MmoservermodModEntities.NETHERITE_GOLEM.get(), 20, 4, 4));
	}
	...
	public static void init() {
		SpawnPlacements.register(MmoservermodModEntities.NETHERITE_GOLEM.get(), SpawnPlacements.Type.ON_GROUND,
