...
import net.mcreator.mmoservermod.procedures.OrichalcumGolemRightClickedOnEntityProcedure;
import net.mcreator.mmoservermod.init.MmoservermodModEntities;

public class OrichalcumGolemEntity extends PathfinderMob {
	...
	public OrichalcumGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MmoservermodModEntities.ORICHALCUM_GOLEM.get(), world);
	}

	public OrichalcumGolemEntity(EntityType<OrichalcumGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		OrichalcumGolemRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
