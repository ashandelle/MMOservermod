...
import net.mcreator.mmoservermod.procedures.LonsdaleiteGolemRightClickedOnEntityProcedure;
import net.mcreator.mmoservermod.init.MmoservermodModEntities;

public class LonsdaleiteGolemEntity extends PathfinderMob {
	...
	public LonsdaleiteGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MmoservermodModEntities.LONSDALEITE_GOLEM.get(), world);
	}

	public LonsdaleiteGolemEntity(EntityType<LonsdaleiteGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LonsdaleiteGolemRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
