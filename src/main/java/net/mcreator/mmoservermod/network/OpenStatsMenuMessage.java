...
import net.mcreator.mmoservermod.procedures.OpenStatsMenuOnKeyPressedProcedure;
...
public class OpenStatsMenuMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenStatsMenuOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		MmoservermodMod.addNetworkMessage(OpenStatsMenuMessage.class, OpenStatsMenuMessage::buffer, OpenStatsMenuMessage::new,
				OpenStatsMenuMessage::handler);
	}
}
