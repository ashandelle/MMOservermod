...
import net.mcreator.mmoservermod.world.inventory.PlayerStatsMenu;
...
public class PlayerStatsScreen extends AbstractContainerScreen<PlayerStatsMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("mmoservermod:textures/player_stats.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "LVL: " + (int) ((entity.getCapability(MmoservermodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new MmoservermodModVariables.PlayerVariables())).player_level) + "", 60, 7, -12829636);
		this.font.draw(poseStack,
				"EXP: " + (int) ((entity.getCapability(MmoservermodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
						...
						+ "%)",
				6, 25, -12829636);
		this.font.draw(poseStack, "Stat Points: " + ((entity.getCapability(MmoservermodModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new MmoservermodModVariables.PlayerVariables())).player_statpoints) + "", 6, 88, -12829636);
	}
